    ...
    <h1>Disease Prediction</h1>
            ...
            <form action="pyfile.php" method="post">
                <div class="containers">
                    <div class="information">
                        <div class="flex-container">
                            <h6>Symptom 1<br>
                            <select name="S1" id="gender">
        <?php
        ...
        ?>
                ...
                <button type="submit" name="submit" class="button1 larger-button">Submit</button>
            </div>
